...
| 2026-08-21 | v2.00 | 延伸 Desktop Pet / Spirit City 的主题生态：小窝新增安全的本地颜色主题包编辑器，支持最多 12 个包、应用/移除和四个六位十六进制颜色；安装严格拒绝脚本、URL、图片路径、任意 CSS 和未知字段，主题只改本机房间视觉，不进入宠物档案、任务、Agent 或飞书同步；外部素材包和第三方连接器继续后置 |
