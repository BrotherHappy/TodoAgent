...
- **宠物真的活着**：头、眼、耳、尾巴和四肢独立运动，持续呼吸、随机眨眼并跟随鼠标；点击不同身体部位会歪头、惊讶、击掌或笑着躲开；小窝可选择温柔、元气、冷静、活泼、轻微淘气或安静六种陪伴性格，动作节奏会随性格变化；还可邀请最多 3 个只存在于小窝的纸飞机、云团、苔苔或月蛾伙伴，分别调整节奏并随宠物档案迁移；完成任务后，小窝会从真实完成事实投影“共同完成印章”，今天的印章突出显示，点击可回到原任务；小房间的云灯、植物和任务书架可以用方向键微调位置、用滑杆调整大小，旧宠物档案会自动使用平衡的默认布局。
