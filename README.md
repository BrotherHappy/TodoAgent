...
- **宠物真的活着**：头、眼、耳、尾巴和四肢独立运动，持续呼吸、随机眨眼并跟随鼠标；点击不同身体部位会歪头、惊讶、击掌或笑着躲开；小窝可选择温柔、元气、冷静、活泼、轻微淘气或安静六种陪伴性格，动作节奏会随性格变化；还可邀请最多 3 个只存在于小窝的纸飞机、云团、苔苔或月蛾伙伴，分别调整节奏并随宠物档案迁移；完成任务后，小窝会从真实完成事实投影“共同完成印章”，今天的印章突出显示，点击可回到原任务；小房间的云灯、植物和任务书架可以直接拖动或用方向键微调位置、用滑杆调整大小，旧宠物档案会自动使用平衡的默认布局；小窝还提供明亮日光、柔和灯光和月光夜色三种纯本地氛围，以及四颜色值组成的安全主题包编辑器，主题可以导出为可读 JSON、从本地 JSON 导入并在安装前预览，不改变任务或提醒规则。
